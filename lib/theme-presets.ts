...
export const backgroundPresets: BackgroundPreset[] = [
  ...
  },
  {
    ...
    image: `url(${basePath}background/bg_image_1.png)`,
    size: "cover",
    preview: `url(${basePath}background/bg_image_1.png) center / cover`,
  },
  {
    name: "bg_image_2",
    label: "Background Image 2",
    image: `url(${basePath}background/bg_image_2.png)`,
    size: "cover",
    preview: `url(${basePath}background/bg_image_2.png) center / cover`,
  },
  {
    name: "bg_image_3",
    label: "Background Image 3",
    image: `url(${basePath}background/bg_image_3.png)`,
    size: "cover",
    preview: `url(${basePath}background/bg_image_3.png) center / cover`,
  },
