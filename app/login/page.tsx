...
export default function LoginPage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center px-6">
            {/* Form panel */}
            <Card className="bg-card/70 mx-auto w-full max-w-xl p-6 backdrop-blur-xl">
                <CardHeader>
                    <h1 className="flex items-center gap-3 text-2xl font-semibold tracking-tight uppercase">
                        <Image src={`${basePath}logo/logo_ac_light.svg`} alt={"logo_acleda"} height={27} width={27} />
                        Welcome back
                    </h1>
              ...
              <div className={"w-full flex items-center"}>
                <div className="w-full border-b border-gray-200 dark:border-slate-600"/>
                <p className={"w-2xl text-center"}>or continue with email</p>
                <div className="w-full border-b border-gray-200 dark:border-slate-600"/>
              </div>*/}

                            <Field>
                                <FieldLabel htmlFor="email">Username/AD</FieldLabel>
                                <Input id="email" type="text" placeholder="ABCXXXXX" autoComplete="off" className={""} required />
                            </Field>
